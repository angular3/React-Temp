      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">ВкусноЕда</span>
            </div>
            <p className="text-gray-300 mb-4">
              Доставляем вкусную и свежую еду прямо к вашему порогу. 
              Быстро, качественно, с любовью.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">info@vkusnoeda.ru</span>
              </li>
              <li className="flex items-center space-x-3">
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-3">
                ...
                <div className="text-gray-300">
                  ...
                  <div className="text-sm text-gray-400">Доставка круглосуточно</div>
                </div>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2024 ВкусноЕда. Все права защищены.
          </p>
        </div>
      </div>
    </footer>
